...
QT_MOC_LITERAL(1, 18, 11), // "renderLater"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 9) // "renderNow"

    },
    "VisualizingWindow\0renderLater\0\0renderNow"
};
...
void VisualizingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VisualizingWindow *_t = static_cast<VisualizingWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject VisualizingWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_VisualizingWindow.data,
...
void *VisualizingWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< VisualizingWindow*>(this));
